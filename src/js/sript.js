...
$(document).ready(function () {
    ...
    let selc1 = document.querySelector('#selc1').getAttribute('data-days');
    ...
    function calcDay() {
        let days = $("#selc1").find(':selected').data('days') + $("#selc2").find(':selected').data('days') + $("#selc3").find(':selected').data('days');
        
        return days
    }
    Bt.addEventListener('click', function () {
        document.querySelector('#cost').innerHTML = calcCost();
        document.querySelector('#data-days').innerHTML = calcDay();
        console.log(calcDay());
    })
})
